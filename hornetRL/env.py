...
class FlyEnv:
    ...
    def reset(self, key, batch_size):
        ...
        theta_chaos = jax.random.uniform(k_theta, (n_chaos, 1), minval=-1.5, maxval=1.5)
    ...
    def get_reward_metrics(self, robot_state, u_forces, reward_weights):
        ...
        # --- 6. Total Reward ---
        # FORMULA: Alive + Precision(Reward) + Nudge + Safety(Penalty) - OtherCosts(Penalty)
        alive_reward = 0.0
